...
class ContractClauseTypes(models.Model):
    contract_clause_type_code = models.CharField(unique=True, max_length=3,
                                                 verbose_name='Contract Clause Type Code')
    contract_clause_type_title = models.CharField(unique=True, max_length=55, blank=True, null=True,
                                                  verbose_name='Contract Clause Type Title')
    comments = models.CharField(max_length=2000, blank=True, null=True, verbose_name='Comments')
    ...
    #     return str('%s' % self.contract_pricing_style_code)
    def __str__(self):
        return f"{self.contract_clause_type_code} - {self.contract_clause_type_title}"
...
class ContractClauses(models.Model):
    ...
    contract_clause_type = models.ForeignKey(ContractClauseTypes, on_delete=models.CASCADE,
                                             verbose_name='Contract Clause Type ID', unique=False, default=1)
    contract_clause_number = models.CharField(unique=False, max_length=15, verbose_name='Contract Clause Number')
    contract_clause_title = models.CharField(unique=False, max_length=55, verbose_name='Contract Clause Title')
    comments = models.CharField(max_length=2000, blank=True, null=True, verbose_name='Comments')
    ...
    def __str__(self):
        return f"{self.contract_clause_type} - {self.contract_clause_number}"
